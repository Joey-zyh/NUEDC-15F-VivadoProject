...
vlog -work xilinx_vip  -incr -l axi_vip_v1_1_21 -l smartconnect_v1_0 -l processing_system7_vip_v1_0_23 "+incdir+D:/XilinxVivado/2025.1/Vivado/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib \
...
vlog -work xpm  -incr -l axi_vip_v1_1_21 -l smartconnect_v1_0 -l processing_system7_vip_v1_0_23 "+incdir+../../../ipstatic" "+incdir+D:/XilinxVivado/2025.1/Vivado/data/rsb/busdef" "+incdir+D:/XilinxVivado/2025.1/Vivado/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib \
...
vlog -work xil_defaultlib  -incr -v2k5 "+incdir+../../../ipstatic" "+incdir+D:/XilinxVivado/2025.1/Vivado/data/rsb/busdef" "+incdir+D:/XilinxVivado/2025.1/Vivado/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib \
