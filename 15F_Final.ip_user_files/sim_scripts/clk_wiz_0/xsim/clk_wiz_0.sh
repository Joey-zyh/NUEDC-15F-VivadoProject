...
#
# Script generated by Vivado on Thu Jan 22 17:37:17 +0800 2026
...
simulate()
{
  xsim clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_b2cc.protoinst" -protoinst "protoinst_files/Measure.protoinst" -log simulate.log
}
