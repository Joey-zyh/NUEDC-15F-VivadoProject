...
#
# Script generated by Vivado on Thu Jan 29 20:01:43 +0800 2026
...
#
# Usage        : Measure.sh
#                Measure.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Measure.sh [-reset_run]
#                Measure.sh [-reset_log]
#                Measure.sh [-help]
#
...
export RDI_DATADIR="D:/XilinxVivado/2025.1/Vivado/data"
...
# script info
echo -e "Measure.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Measure.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/XilinxVivado/2025.1/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Measure.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Measure.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Measure.sh [-help]\n\
Usage: Measure.sh [-step]\n\
Usage: Measure.sh [-lib_map_path]\n\
Usage: Measure.sh [-reset_run]\n\
Usage: Measure.sh [-reset_log]\n\
Usage: Measure.sh [-keep_index]\n\
Usage: Measure.sh [-noclean_files]\n\n\
