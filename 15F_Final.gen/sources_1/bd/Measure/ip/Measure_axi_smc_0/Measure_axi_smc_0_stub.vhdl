...
-- Command     : write_vhdl -force -mode synth_stub -rename_top Measure_axi_smc_0 -prefix
--               Measure_axi_smc_0_ Measure_axi_smc_0_stub.vhdl
...
entity Measure_axi_smc_0 is
  ...
  attribute CHECK_LICENSE_TYPE of Measure_axi_smc_0 : entity is "Measure_axi_smc_0,bd_b2cc,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of Measure_axi_smc_0 : entity is "Measure_axi_smc_0,bd_b2cc,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=27,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of Measure_axi_smc_0 : entity is "yes";
end Measure_axi_smc_0;

architecture stub of Measure_axi_smc_0 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN Measure_processing_system7_0_0_FCLK_CLK0, ASSOCIATED_BUSIF M00_AXI:M01_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_b2cc,Vivado 2025.1";
begin
end;
