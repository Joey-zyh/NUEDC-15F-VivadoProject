...
//Date        : Thu Jan 29 20:01:23 2026
//Host        : JoeyBoy-MagicBook running 64-bit major release  (build 9200)
//Command     : generate_target Measure.bd
//Design      : Measure
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "Measure,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Measure,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "Measure.hwdef" *) 
module Measure
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire SPI_0_0_ss_o;
  wire SPI_0_0_ss_t;
  wire [31:0]Top_Module_0_dataout;
  wire [31:0]Top_Module_0_dutyout_high;
  wire [31:0]Top_Module_0_dutyout_low;
  wire [31:0]Top_Module_0_interval_data;
  ...
  Measure_Top_Module_0_0 Top_Module_0
       (.clk_in(processing_system7_0_FCLK_CLK0),
        .dataout(Top_Module_0_dataout),
        .dutyout_high(Top_Module_0_dutyout_high),
        .dutyout_low(Top_Module_0_dutyout_low),
        .interval_data(Top_Module_0_interval_data),
        .rst_n(rst_ps7_0_50M_peripheral_aresetn),
        .signal_in(signal_in),
        .signal_in2(signal_in2));
  Measure_axi_gpio_0_0 axi_gpio_0
       (.gpio2_io_i(Top_Module_0_interval_data),
        .gpio_io_i(Top_Module_0_dataout),
  ...
  Measure_axi_gpio_1_1 axi_gpio_1
       (.gpio2_io_i(Top_Module_0_dutyout_high),
        .gpio_io_i(Top_Module_0_dutyout_low),
        .s_axi_aclk(processing_system7_0_FCLK_CLK0),
  ...
  Measure_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  Measure_rst_ps7_0_50M_0 rst_ps7_0_50M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
